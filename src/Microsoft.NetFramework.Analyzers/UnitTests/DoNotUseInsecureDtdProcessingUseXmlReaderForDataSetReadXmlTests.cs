...
namespace Microsoft.NetFramework.Analyzers.UnitTests
{
    ...
    {
        protected DiagnosticResult GetCA3075DataSetReadXmlCSharpResultAt(int line, int column)
        {
            return GetCSharpResultAt(line, column, CA3075RuleId, string.Format(_CA3075LoadXmlMessage, "ReadXml"));
        }

        protected DiagnosticResult GetCA3075DataSetReadXmlBasicResultAt(int line, int column)
        {
